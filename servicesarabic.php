            ...
            ?>
                    <div class="col-md-4 col-sm-6 col-lg-3  mt-3">
                        <div class="proj-box position-relative w-100">
                            <div class="proj-thumb overflow-hidden w-100"><a href="<?= $link ?>" title=""><img class="img-fluid w-100" src="images/<?= $products[$i]["image"] ?>" alt="<?= $products[$i]["name" . $clang] ?>"></a></div>
                            <div class="proj-info position-absolute">

                                <h3 class="mb-0"><a href="<?= $link ?>" title=""><?= $products[$i]["name" . $clang] ?></a></h3>
                            </div>
                        </div>
                    </div>
