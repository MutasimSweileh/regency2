...
<section class="latest-blog latest_blog_area blog-section blog-wrapper construction-news about-home-3">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-8">
                                            ...
                                            <div class="theiaStickySidebar">
                                                <div class="post-detail w-100">
                                                    ...
                                                    <p class="mt-3"><?= $products[$i]["description" . $clang] ?></p>
